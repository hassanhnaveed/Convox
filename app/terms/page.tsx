    ...
    <>
      ...
      <main style={{ paddingTop: 60 }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px" }}>
          ...
          {[
            { title: "Use of Service", body: "SwiftConvert is provided for lawful personal and commercial use. You may not use this service to convert copyrighted material you do not own or have rights to." },
            { title: "No Warranty", body: "SwiftConvert is provided 'as is' without warranty of any kind. We do not guarantee 100% uptime or conversion accuracy for all file types." },
            { title: "Limitation of Liability", body: "SwiftConvert is not liable for any data loss or damages arising from use of this service. Always keep backups of your original files." },
