    ...
    <>
      ...
      <main style={{ paddingTop: 60 }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px" }}>
          ...
          {[
            { title: "Files & Privacy", body: "SwiftConvert processes your files entirely in server memory. We do not store, log, or share any uploaded files. All data is discarded immediately after conversion." },
            ...
            { title: "Changes", body: "We may update this policy. Continued use of SwiftConvert constitutes acceptance of any changes." },
          ].map(({ title, body }) => (
