...
export const TOOL_CONFIG = {
  "image-to-webp": {
    ...
    accept: { "image/jpeg": [".jpg", ".jpeg"], "image/png": [".png"], "image/gif": [".gif"], "image/bmp": [".bmp"], "image/tiff": [".tiff", ".tif"], "image/avif": [".avif"] },
    outputExt: ".webp",
  ...
  "webp-to-jpg": {
    ...
    longDesc: "Need JPG compatibility? Convert WebP images to JPG instantly — perfect for apps and platforms that don't yet support WebP.",
  ...
  "webp-to-png": {
    ...
    longDesc: "Convert WebP to PNG and preserve transparency. PNG is the go-to format for graphics with transparent backgrounds.",
  ...
  "heic-to-jpg": {
    ...
    longDesc: "Convert iPhone and iOS HEIC photos to universally compatible JPG format. Works on any device — no software needed.",
  ...
  "image-to-pdf": {
    ...
    longDesc: "Turn one or multiple images into a single PDF document. Perfect for sharing, printing, or archiving photos and scans.",
  ...
  "pdf-merge": {
    ...
    longDesc: "Merge multiple PDF files into one document in seconds. Drag to reorder pages, then download the combined PDF.",
  ...
  "pdf-compress": {
    ...
    longDesc: "Compress PDF files to reduce their size for easy sharing via email or upload. No quality loss on text and vector content.",
